...
import { SearchTerms } from '../models/recipe';
// search for calories and diet types

interface Prop {
    onSubmit: (searchTerm: SearchTerms) => void;
}

const AdvancedSearch = ({onSubmit}: Prop) => {
    const [request, setRequest] = useState<SearchTerms>({label: "", healthLabel: "", calories: 0});
